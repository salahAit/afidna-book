...
bcrypt}\label{password-hashing-with-bcrypt}

Never store plain passwords. Always hash.

\subsection{Why bcrypt?}\label{why-bcrypt}
...
bcrypt is: - \textbf{Slow by design} (prevents brute force) -
\textbf{Salted automatically} (prevents rainbow tables) -
\textbf{Configurable cost} (adjust for hardware)
