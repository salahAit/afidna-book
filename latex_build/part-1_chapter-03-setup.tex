...
\begin{quote}
\textbf{Note}: We use \passthrough{\lstinline!bun:sqlite!} (built-in)
instead of \passthrough{\lstinline!better-sqlite3!}, and
\passthrough{\lstinline!Bun.password!} instead of
\passthrough{\lstinline!bcrypt!} for 25x faster hashing!
\end{quote}
...
\begin{figure}
\centering
\includegraphics[width=0.6\linewidth,height=\textheight,keepaspectratio]{../static/images/chapter-03/file-structure.png}
