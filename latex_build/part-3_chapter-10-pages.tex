\chapter{Building Core Pages}\label{building-core-pages}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{10.1 Homepage with Dynamic
Stats}\label{homepage-with-dynamic-stats}

The homepage is your platform's first impression.

\subsection{Load Function}\label{load-function}
...
\subsection{Homepage Component}\label{homepage-component}
...
\section{10.2 Content Listing (Tracks,
Lessons)}\label{content-listing-tracks-lessons}

List pages with filtering and search.

\subsection{Tracks Listing}\label{tracks-listing}
...
\subsection{Lessons Listing with
Search}\label{lessons-listing-with-search}
...
\section{10.3 Detail Pages}\label{detail-pages}

Single item pages with rich content.

\subsection{Single Track Page}\label{single-track-page}
...
\subsection{Single Lesson Page}\label{single-lesson-page}

See Chapter 12 for the full VideoPlayer integration.

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{10.4 Search Functionality}\label{search-functionality}
...
\section{10.5 User Dashboard}\label{user-dashboard}
...
\section{10.6 Error and 404 Pages}\label{error-and-404-pages}
...
\begin{quote}
\textbf{Next Chapter}: \href{./chapter-11-components.md}{Chapter 11:
Reusable Components}
\end{quote}
